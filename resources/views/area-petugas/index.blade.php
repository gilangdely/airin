<x-layout.app title="Area Petugas" activeMenu="area-petugas" :withError="true">
    <div class="my-5 container-fluid">
        <x-ui.breadcrumb title="Area Petugas" :breadcrumbs="[
        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('area-petugas create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('area-petugas.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                hx-get="{{ route('area-petugas.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#area-petugas-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari area petugas...</span>
                    </div>
                </div>

                <div id="area-petugas-table">
                    @include('area-petugas.includes.index-table', compact('areaPetugas'))
                </div>
            </div>
        </div>
    </div>
