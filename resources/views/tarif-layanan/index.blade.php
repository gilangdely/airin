                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('tarif-layanan create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('tarif-layanan.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                hx-get="{{ route('tarif-layanan.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#tarif-layanan-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari tarif layanan...</span>
                    </div>
                </div>

                <div id="tarif-layanan-table">
                    @include('tarif-layanan.includes.index-table', compact('tarifLayanan'))
                </div>
            </div>
        </div>
    </div>
