<x-layout.app title="Layanan" activeMenu="layanan" :withError="true">
    <div class="my-5 container-fluid">
        <x-ui.breadcrumb title="Layanan" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('layanan create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('layanan.create') }}" class="btn btn-primary w-100 w-md-fit">
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari layanan...</span>
                    </div>
                </div>

                <div id="layanan-table">
                    @include('layanan.includes.index-table', compact('layanan'))
                </div>
            </div>
        </div>
    </div>
