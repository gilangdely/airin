<x-layout.app title="Pelanggan" activeMenu="pelanggan" :withError="true">
    <div class="my-5 container-fluid">
        <x-ui.breadcrumb title="Pelanggan" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('pelanggan create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('pelanggan.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                hx-get="{{ route('pelanggan.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#pelanggan-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari pelanggan...</span>
                    </div>
                </div>

                <div id="pelanggan-table">
                    @include('pelanggan.includes.index-table', compact('pelanggan'))
                </div>
            </div>
        </div>
    </div>
